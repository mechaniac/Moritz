...
import { moritzModuleSkinFor, moritzModuleSkinIds } from './moduleSkins.js';
import {
  MgModuleSwitcher,
  MgSkinProvider,
  MgWorkbench,
...
} from '@christof/magdalena/react';

const tabs: MgModuleDefinition<ModuleId>[] = [
  {
    id: 'glyphsetter',
    label: <MoritzLabel text="Glyph" size={13} />,
    title: 'Glyph',
    skinId: moritzModuleSkinIds.glyphsetter,
  },
  {
    id: 'bubblesetter',
    label: <MoritzLabel text="Bubble" size={13} />,
    title: 'Bubble',
    skinId: moritzModuleSkinIds.bubblesetter,
  },
  {
    id: 'stylesetter',
    label: <MoritzLabel text="Style" size={13} />,
    title: 'Style',
    skinId: moritzModuleSkinIds.stylesetter,
  },
  {
    id: 'typesetter',
    label: <MoritzLabel text="Type" size={13} />,
    title: 'Type',
    skinId: moritzModuleSkinIds.typesetter,
  },
];
...
function AppShell(): JSX.Element {
  ...
  const activeSkin = moritzModuleSkinFor(module);
  ...
  return (
    <MgWorkbench>
      <MgSkinProvider
        ...
        appId="moritz"
        skin={activeSkin}
        className={`mz-module-skin mz-module-skin--${module}`}
      >
        <MgViewportLayer>
          <div
